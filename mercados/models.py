...
class ValorInstrumento(models.Model):
    ...
    valor = models.DecimalField(max_digits=20, decimal_places=2)  # Aquí guardas el valor numérico, ej: 1524.50
    moneda = models.CharField(max_length=3, default='CLP')       # Moneda: 'CLP', 'COP', 'PEN'


# ------------------------------------------------------------------
# Modelos que faltaban (los que ya registraste en admin.py)
# ------------------------------------------------------------------
...
# ------------------------------
from django.db import models  # (si ya está arriba, no dupliques)
...
class Empresa(models.Model):
    ...
    # Relación con país (usa tu modelo Pais con PK=codigo). Lo dejamos opcional para carga flexible.
    ...
    capitalizacion = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
